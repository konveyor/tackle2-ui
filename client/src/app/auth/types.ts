 ...
 * auth/types.ts
 *
 * Shared types for the auth module. Consumers import from "@app/auth" (index.ts),
 * not directly from this file.
 */

/** Realm roles recognised by Tackle. */
...
export interface AuthState {
  /** True when the OIDC session is fully initialised (or auth is disabled). */
  isLoaded: boolean;
