...
/**
 * Target Profiles Section Component
 *
 * This component manages target profiles locally within the archetype form.
 * It does not submit profiles to the backend directly - all profiles are
 * submitted together when the parent archetype form is submitted.
 */
export const TargetProfilesSection: React.FC<TargetProfilesSectionProps> = ({
  ...
  const handleConfirmDelete = () => {
    if (profileToDelete) {
      ...
      // Update parent archetype form's local state
  ...
  /**
   * Handle save profile from the target profile form
   * This updates the local profiles array in the parent archetype form.
   * The profiles will be submitted to the backend when the archetype form is submitted.
   */
