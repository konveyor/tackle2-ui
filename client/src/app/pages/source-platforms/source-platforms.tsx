...
import PlatformFormDataWaiter from "./components/platform-form";
...
const SourcePlatforms: React.FC = () => {
  ...
  return (
    <>
                              ...
                              ...[
                                {
                                  ...
                                  onClick: () =>
                                    console.log(
                                      "Discover applications action clicked"
                                    ),
                                },
                              ],
                              { isSeparator: true },
      ...
      >
        <PlatformFormDataWaiter onClose={() => setOpenCreatePlatform(false)} />
      </Modal>
