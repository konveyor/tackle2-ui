...
export const useInfiniteServerTasks = (
  ...
  // eslint-disable-next-line @tanstack/query/exhaustive-deps -- infinite query intentionally tracks all pages under one key; initialParams seeds pageParam only
