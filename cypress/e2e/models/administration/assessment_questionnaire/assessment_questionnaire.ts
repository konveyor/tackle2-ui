...
export class AssessmentQuestionnaire {
  ...
  public static open(forceReload = false) {
    ...
    if (forceReload) {
      cy.visit(AssessmentQuestionnaire.fullUrl, { timeout: 35 * SEC }).then(
        (_) => {
          cy.wait(10 * SEC);
  ...
  static validateNumberOfMatches(
    section: string,
  ...
  static backToQuestionnaire(): void {
    cy.get("button.pf-v5-c-button.pf-m-link")
      .contains("Back to questionnaire")
      .click();
