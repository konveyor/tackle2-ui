...
export class Jira {
  ...
  public getProject(
    projectName = "Test"
  ): Cypress.Chainable<JiraProject | null> {
  ...
  public getProjectById(
    ...
    return this.doJiraRequest<JiraProject>(
      `${this.url}/rest/api/2/project/${projectId}`
    );
  }

  public getAllIssueTypes(): Cypress.Chainable<JiraIssueType[]> {
    return this.doJiraRequest<JiraIssueType[]>(
      `${this.url}/rest/api/2/issuetype`
    );
  }
    ...
    return cy
      .request({
        ...
        headers: {
          ...
          Authorization:
            this.credential.type === CredentialType.jiraBasic
              ? basicAuth
              : bearerAuth,
        },
      })
