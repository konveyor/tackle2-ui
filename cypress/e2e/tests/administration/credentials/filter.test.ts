...
describe(["@tier3"], "Credentials filter validations", function () {
  ...
  it("Name filter validations", () => {
    ...
    const firstName = credentialsListByDefaultAdmin[0].name;
    const secondName = credentialsListByDefaultAdmin[1].name;
    const validSearchInput = firstName.substring(0, 3);
