...
export enum MigrationWaveView {
  ...
  issueManagerSelectToggle = "#issue-manager-select-toggle",
  instanceSelectToggle = "#tracker-select-toggle",
  projectSelectToggle = "#project-select-toggle",
  issueTypeSelectToggle = "#issue-type-select-toggle",
