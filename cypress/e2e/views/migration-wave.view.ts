...
export enum MigrationWaveView {
  ...
  issueManagerSelectToggle = "[data-ouia-component-id='issue-manager-select-toggle'] [data-ouia-component-type='PF5/TextInput']",
  instanceSelectToggle = "[data-ouia-component-id='tracker-select-toggle'] [data-ouia-component-type='PF5/TextInput']",
  projectSelectToggle = "[data-ouia-component-id='project-select-toggle'] [data-ouia-component-type='PF5/TextInput']",
  issueTypeSelectToggle = "[data-ouia-component-id='issue-type-select-toggle'] [data-ouia-component-type='PF5/TextInput']",
