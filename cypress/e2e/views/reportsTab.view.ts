...
export const applicationConfidenceandRiskTitle =
  'h3:contains("Application confidence and risk")';
export const articleItem = "div.pf-v6-l-stack__item";
export const articleCard = "div.pf-v6-c-card";
export const articleHeader = "div.pf-v6-c-card__header";
export const articleButton = "button.pf-v6-c-button.pf-m-plain";
...
export const landscapeFilterDropdown =
  "button[aria-label='select questionnaires dropdown toggle']";
