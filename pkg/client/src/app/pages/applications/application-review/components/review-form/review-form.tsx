...
import { getValidatedFromError, getValidatedFromErrorTouched } from '@app/utils/utils';
import { number } from 'yup';
import { Application, EffortEstimate, ProposedAction, Review } from '@app/api/models';
import { createReview, updateReview } from '@app/api/rest';
import { ISimpleOptionDropdown, toISimpleOptionDropdownWithValue } from '@app/utils/model-utils';
  ...
  return (
    <FormikProvider value={formik}>
      <Form onSubmit={formik.handleSubmit}>
        ...
        >
          <SingleSelectOptionValueFormikField<ISimpleOptionDropdown<ProposedAction>>
        ...
        >
          <SingleSelectOptionValueFormikField<ISimpleOptionDropdown<EffortEstimate>>
        ...
        >
          <NumberInput
            ...
            max={10}
            onMinus={() => {
              formik.setFieldValue('criticality', (formik.values.criticality || 0) - 1);
            }}
        ...
        >
          <NumberInput
            ...
            max={10}
            onMinus={() => {
              formik.setFieldValue('priority', (formik.values.priority || 0) - 1);
            }}
            onChange={formik.handleChange}
            onPlus={() => {
              formik.setFieldValue('priority', (formik.values.priority || 0) + 1);
