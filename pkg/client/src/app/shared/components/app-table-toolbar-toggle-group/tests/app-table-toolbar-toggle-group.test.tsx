...
describe('AppTableToolbarToggleGroup', () => {
  ...
  chipsValue.set('description', [{ key: 'engineer', node: 'Enginner' }, 'teacher']);
  ...
  it('Category<key,name> => render chips', () => {
    ...
    expect(wrapper.find('.pf-c-chip-group__label').at(1).text()).toBe('Description');
  ...
  it('Category<key,name> => delete chip group', () => {
    ...
    wrapper.find("button[aria-label='Close chip group']").at(1).simulate('click');
