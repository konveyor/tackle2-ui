...
export const ChipBusinessService: React.FC<IChipBusinessServiceProps> = ({ id }) => {
  ...
  return <NodeFetch isFetching={isFetching} fetchError={fetchError} node={businessService?.name} />;
};
